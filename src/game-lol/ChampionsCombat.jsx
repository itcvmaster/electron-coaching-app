...
import useChampionsCombat from "@/game-lol/useChampionsCombat.jsx";
...
function ChampionsCombat() {
  ...
  const { data, cols, colRenderer, options } = useChampionsCombat({
    filterParams,
    searchParams,
  });
...
export default ChampionsCombat;
